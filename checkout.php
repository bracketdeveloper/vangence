            ...
            <div class="row g-5">
                ...
                <div class="col-lg-7">
                    <div class="p-4 p-lg-5 border border-navy-light">
                        ...
                        <form id="checkout-form" class="row g-3" novalidate>
                            <div class="col-md-6">
                                <label for="bill-fname" class="form-label text-uppercase text-muted"
                                       style="font-size: 0.7rem; font-weight: 500;">First Name</label>
                                <input type="text" class="form-control" id="bill-fname" required pattern=".*\S+.*">
                                <div class="invalid-feedback">Please enter a valid first name.</div>
                            </div>
                            <div class="col-md-6">
                                <label for="bill-lname" class="form-label text-uppercase text-muted"
                                       style="font-size: 0.7rem; font-weight: 500;">Last Name</label>
                                <input type="text" class="form-control" id="bill-lname" required pattern=".*\S+.*">
                                <div class="invalid-feedback">Please enter a valid last name.</div>
                            </div>
                            <div class="col-12">
                                <label for="bill-email" class="form-label text-uppercase text-muted"
                                       style="font-size: 0.7rem; font-weight: 500;">Email Address</label>
                                <input type="email" class="form-control" id="bill-email" required>
                                <div class="invalid-feedback">Please enter a valid email address.</div>
                            </div>
                            <div class="col-12">
                                <label for="bill-address" class="form-label text-uppercase text-muted"
                                       style="font-size: 0.7rem; font-weight: 500;">Street Address</label>
                                <input type="text" class="form-control" id="bill-address" required pattern=".*\S+.*"
                                       placeholder="Apartment, suite, unit, etc.">
                                <div class="invalid-feedback">Please enter your address.</div>
                            </div>
                            <div class="col-md-6">
                                <label for="bill-city" class="form-label text-uppercase text-muted"
                                       style="font-size: 0.7rem; font-weight: 500;">City</label>
                                <input type="text" class="form-control" id="bill-city" required pattern=".*\S+.*">
                                <div class="invalid-feedback">Please enter your city.</div>
                            </div>
                            <div class="col-md-6">
                                <label for="bill-state" class="form-label text-uppercase text-muted"
                                       style="font-size: 0.7rem; font-weight: 500;">State</label>
                                <input type="text" class="form-control" id="bill-state" required pattern=".*\S+.*">
                                <div class="invalid-feedback">Please enter your state.</div>
                            </div>
                            <div class="col-12">
                                <label for="bill-phone" class="form-label text-uppercase text-muted"
                                       style="font-size: 0.7rem; font-weight: 500;">Phone Number</label>
                                <input type="tel" class="form-control" id="bill-phone" required pattern="[0-9]{10,}">
                                <div class="invalid-feedback">Please enter a valid phone number (minimum 10 digits).
                                </div>
                            </div>

                            <h3 class="h5 text-uppercase tracking-wider text-navy mt-5 mb-4 fw-bold">Payment
                                Details</h3>
                            ...
                            <div id="card-payment-fields" class="row g-3">
                                <div class="col-12">
                                    <label for="card-num" class="form-label text-uppercase text-muted"
                                           style="font-size: 0.7rem; font-weight: 500;">Card Number</label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-transparent border-navy-light text-navy"><i
                                                    class="fa-solid fa-credit-card"></i></span>
                                        <input type="text" class="form-control border-start-0" id="card-num"
                                               pattern="\d{16}" placeholder="0000 0000 0000 0000">
                                    </div>
                                    <div class="invalid-feedback">Enter 16-digit card number.</div>
                                </div>
                                <div class="col-md-6">
                                    <label for="card-expiry" class="form-label text-uppercase text-muted"
                                           style="font-size: 0.7rem; font-weight: 500;">Expiration Date</label>
                                ...
                                <div class="col-md-6">
                                    <label for="card-cvc" class="form-label text-uppercase text-muted"
                                           style="font-size: 0.7rem; font-weight: 500;">CVC / CVV</label>
                                    <input type="text" class="form-control" id="card-cvc" pattern="\d{3,4}"
                                           placeholder="000">
                ...
                <div class="col-lg-5">
                    <div class="cart-summary-box bg-light border-0 p-4 p-lg-5 h-100">
                        <h3 class="h5 pb-3 mb-4 border-bottom border-navy tracking-wider text-uppercase fw-bold">Order
                            Summary</h3>

                        <div id="checkout-summary-items" class="d-flex flex-column gap-3 mb-4"
        ...
        <div class="d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <span class="text-muted d-block" style="font-size: 0.75rem;">Size: ${item.size} | Color: ${item.color} | Qty: ${item.qty}</span>
                </div>
            </div>
