    ...
    <div class="container-fluid px-lg-5 position-relative" style="z-index: 2;">
        <div class="row">
            <div class="col-xl-6 col-lg-8">
                <span class="text-uppercase tracking-widest text-navy fw-semibold mb-2 d-inline-block" style="font-size: 0.85rem;">New Arrival Edit</span>
                <h1 class="display-3 text-navy fw-bold text-uppercase mb-4" style="line-height: 1.1; letter-spacing: -1px;">
                    The Navy &<br>White Edit
                </h1>
                <p class="fs-5 text-navy opacity-75 mb-5 max-width-500" style="line-height: 1.6; font-weight: 300;">
                    Uncompromising tailoring. Premium Egyptian cotton. A curated line of high-end daily essentials crafted in our signature dual-tone palette.
                </p>
...
<section class="py-5 mt-5">
    <div class="container-fluid px-lg-5">
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <div class="category-card">
                    ...
                    <div class="category-card-content">
                        <span class="category-card-subtitle text-uppercase tracking-widest mb-1 d-block" style="font-size: 0.75rem;">Discover</span>
                        <h2 class="h4 text-uppercase tracking-wider mb-3">Men's Collection</h2>
                        <a href="shop.php?category=men" class="category-card-link text-uppercase fw-semibold text-decoration-none" style="font-size: 0.85rem;">
            ...
            <div class="col-md-6">
                <div class="category-card">
                    <img src="assets/images/prod_women_western.jpg" alt="Women's Collection" class="category-card-img">
                    <div class="category-card-content">
                        <span class="category-card-subtitle text-uppercase tracking-widest mb-1 d-block" style="font-size: 0.75rem;">Discover</span>
                        <h2 class="h4 text-uppercase tracking-wider mb-3">Women's Collection</h2>
                        <a href="shop.php?category=women" class="category-card-link text-uppercase fw-semibold text-decoration-none" style="font-size: 0.85rem;">
                            View Shop <i class="fa-solid fa-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
...
<!-- Curated Classics (Featured Products Grid) -->
<section class="py-5">
    <div class="container-fluid px-lg-5">
        ...
        <div class="row g-4 justify-content-center">
            <?php
            // Pull the first 4 products from mock database
...
<!-- Editorial Promo CTA Banner -->
<section class="py-5 mt-5 bg-light border-top border-bottom border-light">
    <div class="container-fluid px-lg-5">
        <div class="row align-items-center g-0">
            <!-- Text Content -->
            <div class="col-lg-6 bg-navy text-white p-5 p-lg-5 d-flex flex-column justify-content-center" style="min-height: 480px;">
                ...
                <p class="text-white-50 mb-5" style="line-height: 1.8; font-size: 0.9rem;">
                    Vangence designs products around the principles of restraint and utility. By stripping away heavy logos and distracting colors, we emphasize the tactile quality of long-staple fabrics, clean double-stitches, and precise fittings.
                </p>
                <div>
                    <a href="shop.php" class="btn btn-white text-navy bg-white border-white px-4 py-3">Shop the Philosophy</a>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div style="height: 480px; overflow: hidden;">
                    <img src="assets/images/prod_stitched_latha.jpg" alt="Vangence Tailoring" class="w-100 h-100 object-fit-cover">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container px-lg-5">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <a href="about.php" class="btn btn-outline-navy mt-2 mb-4 text-uppercase" style="font-size: 0.8rem; padding: 10px 20px;">Read Our Full Story</a>
            </div>
            <div class="col-lg-6">
                <div class="row g-3">
                    <div class="col-6">
...
<section id="contact" class="py-5 bg-navy text-white">
    <div class="container px-lg-5 py-4">
        <div class="row g-5">
            ...
            <!-- Contact Info -->
            <div class="col-lg-5">
                <span class="text-uppercase tracking-widest text-white-50 mb-2 d-inline-block" style="font-size: 0.8rem;">Get In Touch</span>
                ...
                <div class="d-flex flex-column gap-3">
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-white-50 mb-0" style="font-size: 0.8rem;">1024 Navy Boulevard, Design District, NY 10013</p>
                        </div>
                    </div>
            ...
            <div class="col-lg-7">
                <form onsubmit="event.preventDefault(); alert('Message sent successfully!'); this.reset();" class="row g-3">
                    <div class="col-md-6">
                        <label for="contact-name" class="form-label text-uppercase text-white-50" style="font-size: 0.75rem; font-weight: 500;">Full Name</label>
                        <input type="text" class="form-control bg-white text-navy border-0 shadow-none py-2" id="contact-name" required style="border-radius: 0;">
                    </div>
                    <div class="col-md-6">
                        <label for="contact-email" class="form-label text-uppercase text-white-50" style="font-size: 0.75rem; font-weight: 500;">Email Address</label>
                        <input type="email" class="form-control bg-white text-navy border-0 shadow-none py-2" id="contact-email" required style="border-radius: 0;">
                    </div>
                    <div class="col-12">
                        <label for="contact-subject" class="form-label text-uppercase text-white-50" style="font-size: 0.75rem; font-weight: 500;">Subject</label>
                        <input type="text" class="form-control bg-white text-navy border-0 shadow-none py-2" id="contact-subject" required style="border-radius: 0;">
                    </div>
                    <div class="col-12">
                        <label for="contact-message" class="form-label text-uppercase text-white-50" style="font-size: 0.75rem; font-weight: 500;">Message</label>
                        <textarea class="form-control bg-white text-navy border-0 shadow-none py-2" id="contact-message" rows="4" required style="border-radius: 0;"></textarea>
                    </div>
                    <div class="col-12 mt-4">
                        <button type="submit" class="btn btn-white text-navy bg-white border-white px-4 py-3 w-100">Send Message</button>
                    </div>
                </form>
            </div>
