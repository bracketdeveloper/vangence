...
// Helper to convert JSON strings to comma separated values
$sizesData = json_decode($product[0]["sizes"], true);
$sizesValue = is_array($sizesData) ? implode(", ", $sizesData) : $product[0]["sizes"];
$colorsData = json_decode($product[0]["colors"], true);
$colorsValue = is_array($colorsData) ? implode(", ", $colorsData) : $product[0]["colors"];
?>
    <!-- Page Wrapper -->
    <div id="wrapper">
    <!-- Sidebar -->
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="edit-product-name"
                                           autofocus value="<?php echo htmlspecialchars($product[0]["product_name"]); ?>"/>
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="edit-sizes"
                                           value="<?php echo htmlspecialchars($sizesValue); ?>" placeholder="S, M, L, XL"/>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Colors (comma separated)</label>
                                    <input type="text" class="form-control" id="edit-colors"
                                           value="<?php echo htmlspecialchars($colorsValue); ?>" placeholder="Navy, White"/>
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <textarea class="form-control" id="edit-description" rows="3"><?php echo htmlspecialchars($product[0]["description"]); ?></textarea>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Product Details</label>
                                    <textarea class="form-control" id="edit-details" rows="3" placeholder="Materials, Care instructions..."><?php echo htmlspecialchars($product[0]["details"] ?? ''); ?></textarea>
                                </div>
                                <div class="mb-3 col-md-12">
